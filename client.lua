...
-- Trapper-Vendor-Guarma
Citizen.CreateThread(function()
	exports['qbr-core']:createPrompt('Trapper-Vendor-Guarma', vector3(1349.1, -6842.81, 49.47), 0xF3830D8E, 'Stawberry Trapper Vendor', {
		type = 'client',
		event = 'rsg_trappervendor:client:menu',
		args = { },
	})
...
RegisterNetEvent('rsg_trappervendor:client:menu', function(data)
    exports['qbr-menu']:openMenu({
        ...
        {
            header = "Sell Pelts or Wood to Trapper",
            txt = "will sell all your pelts or wood in your inventory",
            params = {
